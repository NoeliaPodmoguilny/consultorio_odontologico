...
//    @ElementCollection
    ...
    //    RELACION CON LA TABLA DIAGNOSTICO 
    @OneToOne
    ...
    public HistorialMedico(Long idHistorialMedico, LocalDate fechaIngreso, String genero, int edad, String calle, String altura, String ciudad, String provincia, String estadoSalud, int peso, int alturaCm, List<String> condiciones, String medicamentos, List<String> habitos, String otrosHabitos, List<String> historialFamiliar, String otrosHistorialFamiliar, String embarazo, String seguroMedico, String seguroMedicoDescripcion, String comentarios, String contactoNombre, String contactoTelefono, String contactoRelacionConPaciente, Diagnostico diagnostico, Paciente paciente) {
